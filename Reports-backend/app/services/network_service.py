...
logger = logging.getLogger("reports.network")


class NetworkDetectionService:
    """
    Detects connectivity between a vessel (offline) Reports-backend instance
    and the shore (online) instance. Same pattern as Drs-backend's
    network_service.py.
    """
