...
const ClosedDefects = () => {
  ...
  return (
    <div className="dashboard-container">
      <div className="section-header-with-filters" style={{ 
        display: 'flex', 
        justifyContent: 'space-between', 
        alignItems: 'center',
        marginBottom: '20px'
      }}>
        <h1 className="page-title" style={{ margin: 0, fontSize: '24px', color: '#0f172a' }}>
          Closed Defects Archive
        </h1>
        <div className="filter-controls">
          <div className="v-search-box" style={{
            background: 'white',
            ...
            <input
              type="text"
              placeholder="Search closed defects..."
              value={searchQuery}
      ...
      <div style={{
        ...
        <span style={{ fontSize: '14px', color: '#166534' }}>
          Showing {closedDefects.length} completed {closedDefects.length === 1 ? 'defect' : 'defects'} with evidence documentation
        </span>
      </div>
            ...
            {closedDefects.length > 0 ? (
              closedDefects.map(defect => (
                <React.Fragment key={defect.id}>
                  <tr style={{ borderBottom: '1px solid #f1f5f9', opacity: 0.9 }}>
                    ...
                    <td style={{ fontSize: '13px', color: '#64748b' }}>
                      {new Date(defect.closed_at || defect.updated_at).toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'short',
                        day: 'numeric'
                      })}
