...
class User(ControlBase):
    ...
    role_code = Column(String, nullable=True)  # SURVEY_COORDINATOR | TA | TSI | TM — task-management module only
    ...
    permissions = Column(JSONB, nullable=False, server_default='{"drs": false, "jira": false, "voyage": false, "lubeoil": false, "engine_performance": false, "task_management": false}')
